...
func GetModelMetadata(ctx context.Context, doc *enigma.Doc, appID string, headers http.Header, keyOnly bool) *ModelMetadata {
	...
	restMetadata, err := rest.ReadRestMetadata(appID, headers)
